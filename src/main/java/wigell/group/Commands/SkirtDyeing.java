...
public class SkirtDyeing implements ClothCommand {
  private String [] colors = {"Black", "Blue"};


  @Override
  public Skirt finish(Cloth cloth) {
    while (true) {
      ...
      if (colorNumber > 0 && colorNumber <= colors.length) {
        ...
        System.out.println("You chose " + colors[colorNumber - 1] + " as the desired \"color\" for your ordered skirt");
